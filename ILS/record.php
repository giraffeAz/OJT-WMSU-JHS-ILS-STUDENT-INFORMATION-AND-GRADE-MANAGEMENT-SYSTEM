...
<html lang="en">
    ...
    <?php require_once 'page_sections/adviserNav.php'; ?>
            ...
            <div class="container container-fluid cardtablePanel">
                        ...
                        include 'functions/connectdb.php';
                        $yearid = $_GET['yearid'];
						$query = mysqli_query($con,"SELECT total_grade_subject.tgs_id, total_grade_subject.subject_id, total_grade_subject.1st_grading, total_grade_subject.2nd_grading, total_grade_subject.3rd_grading, total_grade_subject.4th_grading, total_grade_subject.final_grade, total_grade_subject.remarks, total_grade_subject.sy_id, school_year.sy_id, school_year.status, subjects.subject as sub FROM total_grade_subject 
						...
						?>
                                ...
                                <td class="text-center" style="color:red;"><?php echo $row['1st_grading'] ?></td>
                               ...
                               <?php if($second>=75){
                                ...
                                <td class="text-center" style="color:red;"><?php echo $row['2nd_grading'] ?></td>
                               ...
                               <?php } ?>
                                ...
                                <td class="text-center" style="color:red;"><?php echo $row['3rd_grading'] ?></td>
                               ...
                               <?php } ?>
                                ...
                                <td class="text-center" style="color:red;"><?php echo $row['4th_grading'] ?></td>
                               <?php } ?>

                                <!----FINAL GRADE------>
                                <?php if($final>=75){
                                    ?>
                                    <td class="text-center" ><?php echo $row['final_grade'] ?></td>
                                <?php 
                                } else {
                                    ?>
                                <td class="text-center" style="color:red;"><?php echo $row['final_grade'] ?></td>
                               <?php } ?>
