                                      ...
                                      <div class="row align-items-center ">
                                        ...
                                        <div class="form-group">
                                          <div class="col-sm-offset-2 col-md-5">
                                            <input type="hidden" name="update_id" id="update_id" value="<?php echo $result['user_id'] ?>" > 
                                            <button id="btn_add" name="updateadviserdata" class="btn btn-add">Save</button>
                                          </div>
                                        </div>
                                      </fieldset>
                                    </form>
